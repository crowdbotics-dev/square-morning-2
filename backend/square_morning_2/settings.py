"""
Django settings for square_morning_2 project.
...
ROOT_URLCONF = 'square_morning_2.urls'
...
WSGI_APPLICATION = 'square_morning_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Square Morning Support <support@square-morning-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_morning_2 API",
    "DESCRIPTION": "API documentation for square_morning_2 App",
    "VERSION": "v1",
}
